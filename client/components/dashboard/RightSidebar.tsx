    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-border-s shrink-0">
          <div className="font-serif text-xl font-semibold text-txt flex items-center gap-2">
        ...
        <div className="flex-1 overflow-y-auto flex flex-col gap-4 mb-4 pr-2 custom-scrollbar">
          <div className="flex flex-col gap-2 animate-fadeUp">
            <div className="max-w-[85%] p-3.5 rounded-xl font-sans text-base leading-relaxed relative bg-elevated border border-border-s text-txt rounded-bl-sm">
            ...
            <div className="font-sans text-xs text-txt-ghost tracking-[0.04em]">
              12:02 PM
            </div>
          </div>

          <div className="flex flex-col gap-2 animate-fadeUp items-end">
            <div className="max-w-[85%] p-3.5 rounded-xl font-sans text-base leading-relaxed relative bg-[rgba(200,240,232,0.12)] border border-[rgba(200,240,232,0.2)] text-txt rounded-br-sm">
        ...
        <div className="border-t border-border-s pt-4 shrink-0">
          <div className="flex flex-wrap gap-2 mb-3">
            <button className="px-3.5 py-2 bg-elevated border border-border-s rounded-md font-sans text-sm text-txt-muted transition-colors hover:bg-glass hover:border-border-a hover:text-txt">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full py-3.5 pl-4 pr-12 bg-elevated border border-border-s rounded-lg text-txt font-sans text-base outline-none resize-none transition-all focus:border-accent focus:shadow-[0_0_0_3px_rgba(200,240,232,0.08)]"
              rows={2}
            />
