...
exports.updateUserPreferences = exports.updateUserSkillLevel = exports.findUserByEmail = exports.upsertUser = exports.findUserByUid = exports.createUserInDb = void 0;
...
const updateUserSkillLevel = (email, skillLevel) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prismaClient_1.default.user.update({
        where: { email },
        data: { skillLevel },
    });
});
exports.updateUserSkillLevel = updateUserSkillLevel;
