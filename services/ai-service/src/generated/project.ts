...
export const Project: MessageFns<Project> = {
  encode(message: Project, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.prerequisiteIds) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.prerequisiteIds.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Project {
    return {
      ...
      initialFiles: isSet(object.initialFiles)
        ...
        : "",
      prerequisiteIds: globalThis.Array.isArray(object?.prerequisiteIds)
        ? object.prerequisiteIds.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.prerequisite_ids)
        ? object.prerequisite_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: Project): unknown {
    ...
    if (message.prerequisiteIds?.length) {
      obj.prerequisiteIds = message.prerequisiteIds;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Project>, I>>(object: I): Project {
    ...
    message.prerequisiteIds = object.prerequisiteIds?.map((e) => e) || [];
    return message;
  },
};
